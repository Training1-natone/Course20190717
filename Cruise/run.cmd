...
IF "%eclipsehome%"=="" (
 set eclipsehome=C:/SoftwareAG_10.3/Designer/eclipse/
)
...
IF "%java%"=="" (
  set java=C:\SoftwareAG_10.3\jvm\jvm\jre\bin\java.exe
)

IF "%eclipseworkspace%"=="" (
  set eclipseworkspace=C:/Training/310-73E/Student/workspace
)

IF "%buildfile%"=="" (
  set buildfile=C:\Training\307-73E\GIT\Cruise\build.xml
)
